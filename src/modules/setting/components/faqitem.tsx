  ...
  return (
    <View
      style={[
        ...
        isExpanded && currentStyle?.FAQItem_expandedBackground_style,
      ]}
    >
      {/* 问题标题区域 */}
      <TouchableOpacity
      ...
      >
        <AnimatedSvgXml
          xml={getSvgXml(
            isExpanded
              ? '#847AF2'
              : (currentStyle?.FAQItem_icon_style?.backgroundColor as string)
          )}
          ...
          <View style={styles.solutionWrapper}>
            ...
            <View
              style={[
                ...
                currentStyle?.FAQItem_contentBackground_style,
              ]}
            >
