...
const ClearModal: FC<ClearModalProps> = ({ clearVisible, setClearVisible }) => {
    ...
    <View style={[styles.container,currentStyle?.background_style]}>
      <View>
          <Text style={[styles.title,currentStyle?.schedule_text_style]}>确定要清除所有消息吗？</Text>
      </View>
      <View><Text style={[styles.content,currentStyle?.schedule_text_style]}>被清除的消息不能恢复哦，请及时查收重要信息</Text></View>
      <View
      style={{
        display: "flex",
        flexDirection: "row",
